...
The report of a systematic review will usually have a number of authors. The ICMJE recommends that authorship be based on the following 4 criteria:
...
Several conceptual frameworks indicate that the effectiveness of dissemination activities is determined by careful consideration of a number of key attributes. These are:
