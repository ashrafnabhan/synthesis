...
The background section should communicate the key contextual factors and conceptual issues relevant to the review question. It should explain why the review is required and provide the rationale underpinning the focus of the review question, for example justifying the choice of interventions to be considered in the review.
...
The inclusion criteria should be set out in the protocol. The elements of the review question, together with study design, will then be refined in order to determine the specific inclusion criteria that will be used when selecting studies for the review.
