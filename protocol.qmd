# Planning an intervention review {#sec-planning-systematic-reviews-of-interventions}
...
The protocol should specify the strategy for data synthesis. It should outline the approach to narrative synthesis. It should state whether a meta-analysis is planned and should specify the outcomes of interest and what effect measures will be used. It should outline how heterogeneity will be explored and quantified, under what circumstances a meta-analysis would be considered appropriate and whether a common effect or random-effects model or both would be used. Any planned subgroup or sensitivity analyses or investigation of publication bias should also be described.
